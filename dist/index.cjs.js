...
var Avatar = function (_a) {
    ...
    var icon = image ? (React__default['default'].createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React__default['default'].createElement(Icon$P, { width: "32px", height: "32px" }));
    if (isExternal) {
